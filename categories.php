<?php
  ...
  */
  ...
  $category = isset($_GET['id']) ? $_GET['id'] : 2;
  ...
  $url = "http://localhost/foodie/api/restaurant?city_id=" . $city."&cat_id=".$category;
  $d = getData($url);

  $cat_url = "http://localhost/foodie/api/categories?category_id=".$category;
  $cat = getData($cat_url);
  ...
  function getImage($url){
    return '<img src="'.urldecode($url).'" alt="Feature Image" />';
  }
...
<head>
  ...
  <title><?php echo $cat[0]->category_name; ?>  Restaurants in <?php echo $c[0]->name; ?> - Zomato</title>
        ...
        <div class="col-l-16 search-top-area clearfix">
          <div class="search-header mb5">
            <h1 class="search_title ptop pb5 fn mb0 mt10 ">
             <?php echo $cat[0]->category_name; ?> Restaurants in <?php echo $c[0]->name; ?></h1>
                                  ...
                                  <div class="pos-relative clearfix    ">
                                    <div class="row">
                                      ...
                                      <div class="col-s-16  col-m-12  pl0  ">
                                        <div class="row">
                                          <div class="col-s-12">
                                            <div class='res-snippet-small-establishment mt5' style='margin-bottom: 7px;'><?php echo $catName[0]->category_name; ?></div>
